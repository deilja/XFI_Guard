...
def test_update_contract_v3():
    u = Path('xfi_guard/updater.py').read_text(encoding='utf-8')
    i = Path('install.sh').read_text(encoding='utf-8')
    assert 'def notify(' in u and 'XFI_GUARD_BOT_TOKEN' in u and 'XFI_GUARD_ADMIN_IDS' in u
