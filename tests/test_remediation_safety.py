...
from xfi_guard.safety.change_guard import ChangeRisk, build_plan
...
def test_safe_plan_can_be_approved_without_confirmation():
    plan = build_plan(action="inspect", target="xray.logs", reason="diagnostics", risk=ChangeRisk.SAFE)
